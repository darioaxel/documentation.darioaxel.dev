# Servidores DHCP
---
title: 'Creación de un sistema de DHCP con VirtualBox'
resume: 'Ejercicio de configuración de un sistema de DHCP en VirtualBox donde el servidor se cuentra instalado en una red y a través de un router, entrega direcciones a clientes de otras redes'
author: 'Darío Ureña'
---
